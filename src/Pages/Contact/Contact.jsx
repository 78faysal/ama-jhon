    ...
    return (
        <div className="mt-10 p-5 md:w-[50%] mx-auto">
            ...
            <form>
                ...
                <div className="mb-6">
                    <label name="repeat-password" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Repeat password</label>
                ...
                <div className="flex items-start mb-6">
                    ...
                    <label name="terms" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree with the <a href="#" className="text-blue-600 hover:underline dark:text-blue-500">terms and conditions</a></label>
                </div>
